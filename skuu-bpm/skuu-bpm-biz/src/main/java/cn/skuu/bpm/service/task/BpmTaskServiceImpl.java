...
import cn.skuu.bpm.enums.definition.*;
import cn.skuu.bpm.enums.task.BpmCommentTypeEnum;
import cn.skuu.bpm.enums.task.BpmReasonEnum;
import cn.skuu.bpm.enums.task.BpmTaskSignTypeEnum;
...
import cn.skuu.bpm.service.definition.BpmModelService;
...
import static cn.skuu.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 skuu-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
