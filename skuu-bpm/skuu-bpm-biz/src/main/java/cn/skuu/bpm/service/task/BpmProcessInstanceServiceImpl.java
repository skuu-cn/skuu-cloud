...
import cn.skuu.bpm.dal.mysql.task.BpmProcessInstanceExtMapper;
...
import cn.skuu.bpm.framework.bpm.core.event.BpmProcessInstanceResultEventPublisher;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    public void cancelProcessInstance(Long userId, @Valid BpmProcessInstanceCancelReqVO cancelReqVO) {
        ...
        if (instance == null) {
            throw exception(ErrorCodeConstants.PROCESS_INSTANCE_CANCEL_FAIL_NOT_EXISTS);
        }
        // 只能取消自己的
        if (!Objects.equals(instance.getStartUserId(), String.valueOf(userId))) {
            throw exception(ErrorCodeConstants.PROCESS_INSTANCE_CANCEL_FAIL_NOT_SELF);
        }
    ...
    private String createProcessInstance0(Long userId, ProcessDefinition definition,
        ...
        if (definition.isSuspended()) {
            throw exception(ErrorCodeConstants.PROCESS_DEFINITION_IS_SUSPENDED);
        }
