package cn.skuu.crm.controller.admin.statistics.vo.customer;
...
public class CrmStatisticsCustomerContractSummaryRespVO {
    ...
    @Schema(description = "客户名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "skuu")
    ...
    @Schema(description = "负责人", requiredMode = Schema.RequiredMode.REQUIRED, example = "skuu")
