...
import cn.skuu.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.skuu.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.skuu.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.skuu.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.skuu.system.dal.dataobject.social.SocialClientDO;
import cn.skuu.system.dal.mysql.social.SocialClientMapper;
...
import static cn.skuu.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${skuu.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${skuu.wxa-subscribe-message.miniprogram-state:formal}")
