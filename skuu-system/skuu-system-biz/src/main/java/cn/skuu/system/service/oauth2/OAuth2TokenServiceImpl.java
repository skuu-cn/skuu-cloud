package cn.skuu.system.service.oauth2;
...
import cn.skuu.system.dal.dataobject.oauth2.OAuth2RefreshTokenDO;
import cn.skuu.system.dal.dataobject.user.AdminUserDO;
import cn.skuu.system.dal.mysql.oauth2.OAuth2AccessTokenMapper;
import cn.skuu.system.dal.mysql.oauth2.OAuth2RefreshTokenMapper;
import cn.skuu.system.dal.redis.oauth2.OAuth2AccessTokenRedisDAO;
...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    /**
     * 加载用户信息，方便 {@link cn.skuu.framework.security.core.LoginUser} 获取到昵称、部门等信息
     *
     * @param userId 用户编号
     * @param userType 用户类型
     * @return 用户信息
