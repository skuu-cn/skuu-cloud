package cn.skuu.system.controller.admin.sms.vo.channel;
...
public class SmsChannelRespVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "skuu")
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "skuu")
