...
import cn.skuu.system.dal.dataobject.dept.UserPostDO;
import cn.skuu.system.dal.dataobject.tenant.TenantDO;
import cn.skuu.system.dal.dataobject.user.AdminUserDO;
import cn.skuu.system.dal.mysql.dept.UserPostMapper;
import cn.skuu.system.dal.mysql.user.AdminUserMapper;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("skuuyuanma");
        ...
        assertEquals("skuuyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("skuuyuanma"))).thenReturn("java");
