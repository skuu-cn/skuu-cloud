package cn.skuu.framework.websocket.config;

import cn.skuu.framework.mq.redis.config.SkuuRedisMQConsumerAutoConfiguration;
import cn.skuu.framework.mq.redis.core.RedisMQTemplate;
import cn.skuu.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.skuu.framework.websocket.core.listener.WebSocketMessageListener;
import cn.skuu.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.skuu.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import cn.skuu.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.skuu.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.skuu.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.skuu.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.skuu.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.skuu.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.skuu.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.skuu.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.skuu.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.skuu.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.skuu.framework.websocket.core.session.WebSocketSessionManager;
import cn.skuu.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
public class SkuuWebSocketAutoConfiguration {
    ...
    public WebSocketConfigurer webSocketConfigurer(HandshakeInterceptor[] handshakeInterceptors,
                                                   ...
                                                   cn.skuu.framework.websocket.config.WebSocketProperties webSocketProperties) {
    ...
    @Bean
    public WebSocketAuthorizeRequestsCustomizer webSocketAuthorizeRequestsCustomizer(cn.skuu.framework.websocket.config.WebSocketProperties webSocketProperties) {
