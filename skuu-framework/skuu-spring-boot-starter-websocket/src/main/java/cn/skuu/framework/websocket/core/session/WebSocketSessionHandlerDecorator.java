package cn.skuu.framework.websocket.core.session;
...
public class WebSocketSessionHandlerDecorator extends WebSocketHandlerDecorator {
    ...
    private final cn.skuu.framework.websocket.core.session.WebSocketSessionManager sessionManager;

    public WebSocketSessionHandlerDecorator(WebSocketHandler delegate,
                                            cn.skuu.framework.websocket.core.session.WebSocketSessionManager sessionManager) {
        super(delegate);
