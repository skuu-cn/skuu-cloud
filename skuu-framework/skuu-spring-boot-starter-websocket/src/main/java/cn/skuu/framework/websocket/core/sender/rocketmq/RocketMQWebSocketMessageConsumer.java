package cn.skuu.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${skuu.websocket.sender-rocketmq.topic}",
        consumerGroup = "${skuu.websocket.sender-rocketmq.consumer-group}",
