package cn.skuu.framework.sms.core.client.impl.tencent;
...
import cn.skuu.framework.sms.core.client.SmsCommonResult;
import cn.skuu.framework.sms.core.client.dto.SmsReceiveRespDTO;
import cn.skuu.framework.sms.core.client.dto.SmsSendRespDTO;
import cn.skuu.framework.sms.core.client.dto.SmsTemplateRespDTO;
import cn.skuu.framework.sms.core.enums.SmsTemplateAuditStatusEnum;
import cn.skuu.framework.sms.core.property.SmsChannelProperties;
import cn.skuu.framework.test.core.ut.BaseMockitoUnitTest;
import cn.skuu.framework.test.core.util.RandomUtils;
...
public class TencentSmsClientTest extends BaseMockitoUnitTest {
    ...
    public void testDoSendSms() throws Throwable {
        ...
        when(client.SendSms(argThat(request -> {
            ...
            assertEquals(JsonUtils.toJsonString(ArrayUtils.toArray(new ArrayList<>(MapUtils.convertMap(templateParams).values()), String::valueOf)),
