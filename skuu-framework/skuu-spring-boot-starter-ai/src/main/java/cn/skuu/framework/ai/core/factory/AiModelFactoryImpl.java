package cn.skuu.framework.ai.core.factory;
...
import cn.skuu.framework.ai.config.SkuuAiAutoConfiguration;
import cn.skuu.framework.ai.config.SkuuAiProperties;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            SkuuAiProperties.MidjourneyProperties properties = SpringUtil.getBean(SkuuAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link SkuuAiAutoConfiguration#deepSeekChatModel(SkuuAiProperties)}
     */
    ...
    /**
     * 可参考 {@link SkuuAiAutoConfiguration#xingHuoChatClient(SkuuAiProperties)}
     */
