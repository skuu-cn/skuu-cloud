package cn.skuu.framework.desensitize.core;

import cn.skuu.framework.common.util.json.JsonUtils;
import cn.skuu.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.skuu.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.skuu.framework.desensitize.core.annotation.Address;
import cn.skuu.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import cn.skuu.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import cn.skuu.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
...
import cn.skuu.framework.desensitize.core.slider.annotation.MobileDesensitize;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("dcx");
        ...
        desensitizeDemo.setRegex("你好，我是dcx");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("dcx");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "dcx", replacer = "*")
