...
import cn.skuu.framework.pay.core.client.PayCommonResult;
import cn.skuu.framework.pay.core.client.dto.PayOrderUnifiedReqDTO;
import cn.skuu.framework.pay.core.client.dto.PayRefundUnifiedReqDTO;
import cn.skuu.framework.pay.core.client.dto.PayRefundUnifiedRespDTO;
...
public abstract class AbstractPayClient<Config extends PayClientConfig> implements PayClient {
    ...
    public final PayCommonResult<?> unifiedOrder(PayOrderUnifiedReqDTO reqDTO) {
        ...
        try {
            ...
            // 打印异常日志
            log.error("[unifiedOrder][request({}) 发起支付失败]", JsonUtils.toJsonString(reqDTO), ex);
            // 封装返回
    ...
    public PayCommonResult<PayRefundUnifiedRespDTO> unifiedRefund(PayRefundUnifiedReqDTO reqDTO) {
        ...
        try {
            ...
            // 记录异常日志
            log.error("[unifiedRefund][request({}) 发起退款失败]", JsonUtils.toJsonString(reqDTO), ex);
