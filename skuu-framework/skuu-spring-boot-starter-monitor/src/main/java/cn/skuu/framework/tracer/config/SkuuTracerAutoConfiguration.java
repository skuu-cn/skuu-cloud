package cn.skuu.framework.tracer.config;

import cn.skuu.framework.common.enums.WebFilterOrderEnum;
import cn.skuu.framework.tracer.core.aop.BizTraceAspect;
import cn.skuu.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "skuu.tracer", value = "enable", matchIfMissing = true)
public class SkuuTracerAutoConfiguration {
